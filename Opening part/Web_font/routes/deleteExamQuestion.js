...
router.get('/', function(req, res, next) {
    ...
    getQuestionExamList(teaId, classId, id, examId, res, req)
});

async function getQuestionExamList(teaId, classId, id, examId, res, req){
    await upload('/exam/student/deleteExamQuestion?id=' + id)
